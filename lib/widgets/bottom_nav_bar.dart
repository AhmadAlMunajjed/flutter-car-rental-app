...
class BottomNavigation extends StatefulWidget {
   String curentid;
   BottomNavigation({Key? key, required this.curentid}) : super(key: key);

  @override
  State createState() => BottomNavigationState(curentid: curentid,);
}

class BottomNavigationState extends State<BottomNavigation> {
  BottomNavigationState({Key? key,  required this.curentid});
