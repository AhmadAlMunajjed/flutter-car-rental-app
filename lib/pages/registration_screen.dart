...
import 'package:car_rental_app_ui/model/user_model.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
      ...
      try {
        ...
        if (documents.isEmpty) {
          ...
          FirebaseFirestore.instance.collection('users').doc(_auth.currentUser!.uid).set({
            'nickname': firstNameEditingController.text + secondNameEditingController.text,
  ...
  postDetailsToFirestore() async {
    ...
    await FirebaseFirestore.instance.collection('users').where(
        'id', isEqualTo: _auth.currentUser!.uid).get();
    final List<DocumentSnapshot> documents = result.docs;
    ...
    Navigator.pushAndRemoveUntil(
        context, MaterialPageRoute(builder: (context) => BottomNavigation(curentid: _auth.currentUser!.uid,)), (
        route) => false);
  }
  }
