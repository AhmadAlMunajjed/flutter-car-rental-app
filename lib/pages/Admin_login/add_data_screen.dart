...
class AddDataScreen extends StatefulWidget {
  ...
  const AddDataScreen({Key? key, required this.currentUserId}) : super(key: key);
                ...
                child: Column(
                  children: [
                   ...
                   task == null ?  loginButton : buildUploadStatus(task!),
                    ...
                    const SizedBox(height: 20.0,),
                    MaterialButton(
                      child: const Text("See Chats",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),
                      ),
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>  ChatList(currentUserId: widget.currentUserId)));
