                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: ()async{
                                            await Share.share("Car Type :${snapshot.data!.docs[index]["carType"]} ,"
                                                "Car Name :${snapshot.data!.docs[index]["carName"]} ,"
                                                "Car Rent :${snapshot.data!.docs[index]["carRent"]} ," "Car Rented: Rented",);
                                          },
                                          child: Padding(
